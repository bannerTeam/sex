...
$(document).ready(function($) {
	...
	if(/Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent)) {
		loadCss("/scripts/video/video.css");
		$("head").append('<script type="text/javascript" src="/scripts/video/video.min.js"></script>');
		$("head").append('<script type="text/javascript" src="/scripts/video/videojs-contrib-hls.js"></script>');
		$("#video").hide();
		yhVideo();
		return false;
	}
