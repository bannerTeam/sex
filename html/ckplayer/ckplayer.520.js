...
function ckstyle() { //定义总的风格
    var ck = {
      ...
      pm_advmarquee: '1,0,0,20,0,36,0,0x000000,55,0,90,18,35,2000',
		...
		*/
    bufferprompt:'{a target="_blank" href="http://www.111222mm.cc"}{font color="#ffffff" size="12" face="Microsoft YaHei,YaHei,微软雅黑,SimHei,黑体"}注册即送188，资金雄厚，取款无忧。！{/font}{/a}',
		mainfuntion:'',
		/*
		...
		*/
		...
		/*
			...
			4、加载滚动文字广告的函
		*/
        myweb: escape('ee4fbf7011165a943e83c1971555a4e1,ppvod.com,http://www.ppvod.com'),
        /*
		------------------------------------------------------------------------------------------------------------------
